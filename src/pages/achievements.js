  ...
  <Layout>
    ...
    <div className="achievements">
      ...
      <div className="achievement-card-container-bg light" data-sal="fade" data-sal-duration="1000">
        <div className="achievement-card" data-sal="slide-up" data-sal-duration="1000">
        <h2>Salesforce Certified Field Service Consultant</h2>
        <p>The Salesforce Certified Field Service Consultant program is designed for consultants who have experience implementing Salesforce Service Cloud and Salesforce Field Service. </p>
        </div>
      </div>
