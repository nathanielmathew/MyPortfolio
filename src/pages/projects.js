    ...
    <div className="projects" name="projects">
      <div className="projects-title-container">
        ...
        <div className="project-card-container">
          ...
          <ProjectCard pname="Eurotech Safety Inventory Management Software" pinfo="Eurotech Safety Inc. is a company that provides Fire, Life Safety, and Security services in Ontario. The Inventory Management solution for this project was Implemented using Salesforce." plink=""/>
